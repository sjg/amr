...
do
	...
	then
                echo "Building:- $FILE"
		claat export --prefix "https://workshops.cetools.org/elements" -o "$CODELAB_OUTPUT_FOLDER" $FILE
	fi
...
rsync -avz /home/sjg/github_push/scripts/workshops-site/dist/ /var/www/workshops.cetools.org/
rsync -avz /home/sjg/github_push/scripts/workshops-site/codelabs/ /var/www/workshops.cetools.org/codelabs/
rsync -avz /home/sjg/github_push/scripts/logs/ /var/www/workshops.cetools.org/build-logs
